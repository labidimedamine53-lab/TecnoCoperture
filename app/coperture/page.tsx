import { RoofTypeShowcase } from "@/components/roof-type-showcase";
...
export default async function CoperturePage() {
  ...
  const coveragePhotoByTypeName: Record<string, string> = {
    ...
    "Tetto piano": "/images/coperture/tetto-piano-new.png",
    "Tetto Piano": "/images/coperture/tetto-piano-new.png",
    "Flat Roof": "/images/coperture/tetto-piano-new.png",
    ...
    "Copertura in pannelli sandwich": "/images/coperture/copertura-pannelli-sandwich-new.png",
    "Sandwich Panel Roof": "/images/coperture/copertura-pannelli-sandwich-new.png",
  ...
  const roofTypeItems = roofingTypes.map((coverage) => ({
    name: coverage.name,
  ...
  return (
    <main className="page-shell py-14">
      ...
      <RoofTypeShowcase items={roofTypeItems} italian={italian} />
    </main>
  );
}
